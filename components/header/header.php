...
<head>
    ...
    <link rel="stylesheet" href="css/my_base_modified.css?v1" type="text/css" />
</head>
...
<body>
    <div class="wrapper">
        <header class="header">
            ...
            echo '<div><span class="headerRightItems"><a href="mailto:' . $result_contact['contact_email'] . '">contact us</a></span></div>';
