...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000006e7e92070000000076bae38b(
...
class phpbbtemplatetwiglexer_000000006e7e92070000000076bae38b extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5da20ebcd94c6353565274 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5da20ebcd94ce909497076 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5da20ebcd94af472416860 = array(
    ...
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, 'set_environment', array('env' => $env), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;

        return $this->valueHolder5da20ebcd94c6353565274->set_environment($env);
    }
    ...
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;

        return $this->valueHolder5da20ebcd94c6353565274->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;

        return $this->valueHolder5da20ebcd94c6353565274->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5da20ebcd94ce909497076 = $initializer;
    }
    ...
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, '__get', array('name' => $name), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;

        if (isset(self::$publicProperties5da20ebcd94af472416860[$name])) {
            return $this->valueHolder5da20ebcd94c6353565274->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5da20ebcd94c6353565274;
    ...
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;
    ...
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, '__isset', array('name' => $name), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;
    ...
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, '__unset', array('name' => $name), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;
    ...
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, '__clone', array(), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;

        $this->valueHolder5da20ebcd94c6353565274 = clone $this->valueHolder5da20ebcd94c6353565274;
    }

    public function __sleep()
    {
        $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, '__sleep', array(), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;

        return array('valueHolder5da20ebcd94c6353565274');
    }
    ...
    {
        return $this->initializer5da20ebcd94ce909497076;
    }
    ...
    {
        return $this->initializer5da20ebcd94ce909497076 && ($this->initializer5da20ebcd94ce909497076->__invoke($valueHolder5da20ebcd94c6353565274, $this, 'initializeProxy', array(), $this->initializer5da20ebcd94ce909497076) || 1) && $this->valueHolder5da20ebcd94c6353565274 = $valueHolder5da20ebcd94c6353565274;
    }
    ...
    {
        return null !== $this->valueHolder5da20ebcd94c6353565274;
    }
    ...
    {
        return $this->valueHolder5da20ebcd94c6353565274;
    }
