...
// there are some syntax errors after this point, plus some old query syntax
...
//             } else {
//                 echo '<p class="text-danger">There was an error uploading the file, <a href="edit_delete_download.php"><b>please try again</b></a>!</p>';
//             }
//         } else {
//             echo '<p class="text-danger">No file was selected for upload!</p>';
...
//         echo '<p class="text-danger">Are you sure you want to permanently delete this download (<b>' . $_POST['description'] . '</b>) and all traces of it from the website?</p><br />';
...
//     echo '<p class="text-danger"><b>An error has occurred!</b></p>';
