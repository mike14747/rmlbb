...
if ($request->is_set_post('login')) {
    ...
    echo '<label for="username">Username: <input type="text" name="username" size="15" /></label> &nbsp;&nbsp;&nbsp;&nbsp;';
    echo '<label for="password">Password: <input type="password" name="password" size="15" /></label> &nbsp;&nbsp;&nbsp;&nbsp;';
    echo '<a href="phpBB3/ucp.php?mode=sendpassword">I forgot my password</a> &nbsp;&nbsp;&nbsp;&nbsp;';
    echo '<label for="autologin">Remember me <input type="checkbox" name="autologin" /></label> &nbsp;&nbsp;&nbsp;&nbsp';
    if (isset($get_page)) {
